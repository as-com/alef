          ...
          value: function render() {
            ...
            if (typeof rules === 'function') {
              ...
              if (process.env.NODE_ENV !== 'production' && !this.warnDeprecated) {
                ...
                console.warn('Using a `mapStylesToProps` function with `connect` is deprecated. It will be removed soon. Use a direct `rules` object. See https://github.com/rofrischmann/alef/blob/master/packages/react-alef/docs/connect.md');
